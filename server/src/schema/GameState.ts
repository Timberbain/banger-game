...
export class Player extends Schema {
  ...
  @type('number') speedMultiplier: number = 1; // synced for client prediction (1.0 = normal, 1.5 = speed buff)
  ...
  activeBuffs: Array<{ type: number; expiresAt: number; duration: number }> = []; // server-only buff tracking
}
